...
INSERT IGNORE INTO employees (
    ...
    phone, role, department_id, designation_id, joining_date, is_active
) VALUES ('EMP001', 'System', 'Administrator', 'admin@revworkforce.com',
'240be518fabd2724ddb6f04eeb9d5b4f8d23cd6b0c0b3c4da9f5f4d7a9b8a3c7', '1234567890', 'ADMIN', 1, 1, '2024-01-01', true
);

INSERT IGNORE INTO employees (
    employee_code, first_name, last_name, email, password,
    phone, role, department_id, designation_id, manager_id, joining_date, is_active
) VALUES ('EMP002', 'Mahi', 'Singh', 'mahi@revworkforce.com',
'5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', '9876543210', 'MANAGER', 2, 3, 1, '2024-01-15', true
);
