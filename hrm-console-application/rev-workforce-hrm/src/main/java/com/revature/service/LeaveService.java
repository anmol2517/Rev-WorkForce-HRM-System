...
public class LeaveService {
    ...
    public void approveLeave(int leaveRequestId, String managerComments) throws AppException {
        ...
        try {
            ...
            logAudit(null, AuditLog.ActionType.APPROVE, AuditLog.EntityType.LEAVE,
    ...
    public void rejectLeave(int leaveRequestId, String managerComments) throws AppException {
        ...
        try {
            ...
            if (success) {
                logAudit(null, AuditLog.ActionType.REJECT, AuditLog.EntityType.LEAVE,
    ...
    public void cancelLeave(int requestId) throws AppException {
        try {
            ...
            logAudit(null, AuditLog.ActionType.CANCEL, AuditLog.EntityType.LEAVE,
    ...
    public void addHoliday(Holiday holiday) throws AppException {
        try {
            ...
            logAudit(null, AuditLog.ActionType.CREATE, AuditLog.EntityType.LEAVE,
